...
<body>
     <header>
        <div class="header-container">
            <div class="logo">
                <a href="#"><img src="${pageContext.request.contextPath}/static/images/logo.png" alt="YoriZip 로고"></a>
            </div>
            <nav class="main-menu">
                <ul>
                    <li><a href="#">든든한끼</a></li>
            ...
            <nav class="user-menu">
                <div class="search-icon">
                    <a href="#"><img src="${pageContext.request.contextPath}/static/images/search-icon.png" alt="검색"></a>
                </div>
                <ul>
                    <!-- 로그인 상태에 따라 표시할 항목들 -->
                    <li class="auth">
