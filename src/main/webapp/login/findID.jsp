        ...
        <div class="email-box">
            <form action="success_findID.jsp" method="post">
                ...
                <div style="width: 100%;">
                    ...
                    <!-- 인증번호 입력 필드 -->
                    <div class="input-label">인증번호</div>
                    <input type="text" name="verificationCode" class="input-num" placeholder="인증번호 6자리의 숫자입력" required>
                    <!-- 아이디 찾기 버튼 -->
                    <button type="submit" class="button_findID">아이디 찾기</button>
                    <!-- Links Container -->
